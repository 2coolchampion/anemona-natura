...
const UslugeCard = ({
  ...
  return (
    <div
      className={`relative z-0 flex h-56 flex-col items-center justify-around overflow-hidden rounded-lg bg-green-dark text-center text-gray-100 xl:h-56 2xl:h-72 ${
